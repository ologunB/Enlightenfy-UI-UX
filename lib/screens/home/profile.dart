    ...
    return BaseView<UserDetailsModel>(
      ...
      builder: (context, model, child) => Scaffold(
        appBar: model.state == ViewState.Busy
            ...
            : AppBar(
                title: Text(model.mUser.firstname + " " + model.mUser.lastname),
                backgroundColor: AppColors.backgroundColor,
              ),
        body: model.state == ViewState.Busy
            ? const Center(child: const CupertinoActivityIndicator(radius: 15))
            : Container(
                  ...
                  child: Column(
                    children: <Widget>[
                            ...
                            children: <Widget>[
                              ExpansionTile(
                                ...
                                children: <Widget>[
                                  const Padding(
                                    ...
                                    child: Text('Introduction details here'),
                                  )
                                ],
                              ),
                              ExpansionTile(
                              ...
                              ExpansionTile(
                                ...
                                children: <Widget>[
                                  const Padding(
                                    padding: EdgeInsets.all(8.0),
                                    child: Text('Experience details here'),
                                  )
                                ],
                              ),
                              ExpansionTile(
                              ...
                              ExpansionTile(
                                ...
                                children: <Widget>[
                                  const Padding(
                                    padding: EdgeInsets.all(8.0),
                                    child: Text('Achievements details here'),
                                  )
                                ],
                              ),
                              ExpansionTile(
                                ...
                                children: <Widget>[
                                  const Padding(
                                    padding: EdgeInsets.all(8.0),
                                    child: Text('information details here'),
                                  )
                                ],
                              ),
                            ],
                      ...
                      ProfileCard(
                        ...
                        onEditPressed: () {
                          showJoinDialog(
                              context, _aboutController, 'Update your about',
